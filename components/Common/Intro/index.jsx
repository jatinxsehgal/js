...
import Jatin from '../../../public/images/jatin.jpg';
  ...
  return (
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
       <a href="https://sehgal.netlify.app/"><span><Image className='w-20 h-20 rounded-full' src={Jatin} alt='profile picture' /></span></a> 
